...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Rison Chan', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '东方欲晓，莫道君行晚。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址,链接在昵称实现
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'chanjames23@outlook.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  MOUSE_FOLLOW_EFFECT_COLOR: '#a2aaf5', // 鼠标点击特效颜色 #xxxxxx 或者 rgba(r,g,b,a)
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    ...
    },
    {
      name: 'K歌之王',
      artist: '陈奕迅',
      url: 'https://music.163.com/song?id=67467&userid=1730852698.mp3',
      cover:
        'https://p1.music.126.net/kn6ugISTonvqJh3LHLaPtQ==/599233837187278.jpg'
    }
  ],
